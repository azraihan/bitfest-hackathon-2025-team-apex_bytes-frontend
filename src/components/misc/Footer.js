...
function Footer({
  ...
  // to get tha current location or base path (that is the part of path just after the host url)
  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={4}>
            ...
            <Box
              ...
              sx={{
                ...
                "& li": {
                  //This targets all <li> elements within the styled component
          ...
          <Grid item xs={12} sm={4}>
            ...
            <Typography
              color={textColor}
              className="hoverScale"
              sx={{ marginTop: "0.7rem", fontfamily: CONTENT }}
            >
              Email: {email}
            </Typography>
            <Typography
          ...
          <Grid item xs={12} sm={4}>
            ...
            >
              <Link href="#" color={textColor} className="iconHoverScale">
                <FaFacebook size="24" />
              </Link>{" "}
              {/**The destination URL for the link. Here, "#" is used as a placeholder, commonly seen in examples or templates. */}
              <Link href="#" color={textColor} className="iconHoverScale">
                <FaInstagram size="24" />
              </Link>
              <Link href="#" color={textColor} className="iconHoverScale">
        ...
        >
          {" "}
          {/**Typogrphy elements can be centered using align */}
          {bottomText}
        </Typography>
      </Container>
    </Box>
